        ...
        @if($editableMode)
            <form wire:submit.prevent="save">
                ...
                <div class="row gutters-0 mt-3">
                        ...
                        <label>name</label>
                        <input wire:model.defer="role.name" type="text" class="form-control @error('role.name') border border-danger @enderror">
                        @error('role.name')
                    ...
                    <div class="form-group col-md-12 mt-2">
                        ...
                        <button wire:click.prevent="cancelEdit" class="btn btn-light font-weight-bolder btn-sm">Cancel</button>
                    </div>
